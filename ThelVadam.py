...
banner =  Fore.CYAN + """;ttttttttttttttttttttttttttttttttt%X:888:;;;X8;S8S88@8@88%X S;;:;ttttttt;ttttttttttt8XXXXXXXXS%SSX@X
...
def ThelVadam():
    print(Fore.GREEN + "_____________________")
    ...
    if sukablyat == "1":
        print("Escribe el texto que quieres codificar")
        encript = input('>> ')
        pito = base64.b64encode(bytes(encript, 'utf-8'))
        print(pito)

    if sukablyat == "2":
        print("Escribe el texto que deseas descodificar")
        descript = input('>> ')
        pussy = base64.b64decode(bytes(descript, 'utf-8'))
        print(pussy)
